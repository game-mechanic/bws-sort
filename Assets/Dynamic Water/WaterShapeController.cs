...
public class WaterShapeController : MonoBehaviour
{
    ...
    /// <summary>
    /// Disables every Collider2D on this GameObject and all its children.
    /// SpriteShapeController auto-generates a PolygonCollider2D each frame and
    /// cannot have isTrigger forced from outside — disabling is the only reliable way
    /// to stop it from physically interacting with bubble Rigidbody2Ds.
    /// </summary>
