...
namespace DT.GridSystem
{
	...
	public class HexGridSystem3D<TGridObject> : GridSystem<TGridObject>
	{
        ...
        /// Now fully supports object transform rotation by converting from local space.
        /// </summary>
        public override Vector3 GetWorldPosition(int x, int y, bool snapToGrid = false)
        {
                ...
                case HexOrientation.PointyTop:
                    {
                        ...
                        localPos = new Vector3(xPos, 0, yPos) + new Vector3(CellSize, 0, CellSize) * 0.5f;
                        break;
                    }
            ...
            // Convert local grid position into rotated/scaled world space
        ...
        /// Now correctly supports rotated transforms by converting into local space first.
        /// </summary>
